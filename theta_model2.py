...
def get_params():
    ...
    #
    # copyed_indx = neurons_params.index[neurons_params['Neuron Type'] == 'CA1 Basket'].values[0]
...
def get_model(params, generators_params, dt):
    ...
    big_model.compile(
        ...
        loss = tf.keras.losses.tf.keras.losses.LogCosh(),    #MeanSquaredLogarithmicError(),
    )
